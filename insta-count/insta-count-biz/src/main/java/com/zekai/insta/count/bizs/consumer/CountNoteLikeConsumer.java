...
import com.zekai.insta.count.bizs.dto.CountLikeUnlikeNoteMqDTO;
import com.zekai.insta.count.bizs.enums.LikeUnlikeNoteTypeEnum;
 ...
 **/
@Component
@RocketMQMessageListener(consumerGroup = "insta_group_" + MQConstants.TOPIC_COUNT_NOTE_LIKE, // Group 组
